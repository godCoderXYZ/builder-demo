...
print("📥 Downloading MNIST with keras...")

# This automatically downloads and loads MNIST
(x_train, y_train), (x_test, y_test) = mnist.load_data()

# Apply your size reductions
x_train = x_train[:16000]
y_train = y_train[:16000]
x_test = x_test[:4000]
y_test = y_test[:4000]
...
np.save('mnist_data/x_test.npy', x_test)
np.save('mnist_data/y_test.npy', y_test)
# np.save('mnist_data/y_train_onehot.npy', y_train_onehot)
# np.save('mnist_data/y_test_onehot.npy', y_test_onehot)

print("✅ MNIST data saved!")
